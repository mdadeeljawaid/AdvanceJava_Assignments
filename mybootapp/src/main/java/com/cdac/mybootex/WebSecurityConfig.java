...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
//	A factory for connections to the physical data source that this DataSource object represents. An alternative to the DriverManager facility, 
//	a DataSource objectis the preferred means of getting a connection.
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests().antMatchers("/list_user").authenticated()
		.anyRequest().permitAll().and()
		.formLogin().usernameParameter("email")
		.defaultSuccessUrl("/list_user").permitAll()
